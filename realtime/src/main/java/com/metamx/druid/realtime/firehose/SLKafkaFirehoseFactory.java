...
/**
 * KafkaFirehouseFactory for Streamlyzer
 */
public class SLKafkaFirehoseFactory implements FirehoseFactory
{
  private static final Logger log = new Logger(SLKafkaFirehoseFactory.class);
